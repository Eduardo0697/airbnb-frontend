                ...
                <div className="container d-flex">
                    <div className="logo mr-auto">
                        <Link  className={` ${isHomeNavigation ? 'text-light' : 'text-dark'} `} to="/">
                            <svg enable-background="new 0 0 24 24" height="50" viewBox="0 0 24 24" width="50"
                    ...
                    <nav className={` nav-menu d-none d-lg-block ${isHomeNavigation ? 'text-light' : 'text-dark'} `}>
                        <ul>
                            ...
                            <li>
                                <Link className={` ${isHomeNavigation ? 'text-light' : 'text-dark'} `} to="/">Explorar</Link>
                            </li>
                            <li>
                                <Link className={` ${isHomeNavigation ? 'text-light' : 'text-dark'} `} to="/">Recibe huéspedes</Link>
                            </li>
                            <li>
                                <Link className={` ${isHomeNavigation ? 'text-light' : 'text-dark'} `} to="/">Registrate</Link>
                            </li>
                            <li>
                                <Link className={` ${isHomeNavigation ? 'text-light' : 'text-dark'} `} to="/">Inicia Sesion</Link>
                            </li>
                        </ul>
                    </nav>
                </div>
